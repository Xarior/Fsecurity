...
# v1.0
## Homepage:
# https://github.com/t2iservices/Fsecurity
## Author:
# T2I SERVICES
################################################################################
...
echo ' ________                                                 __    __'
echo '/        |                                               /  |  /  |'
echo '$$$$$$$$/_______   ______    _______  __    __   ______  $$/  _$$ |_    __    __'
echo '$$ |__  /       | /      \  /       |/  |  /  | /      \ /  |/ $$   |  /  |  /  |'
echo '$$    |/$$$$$$$/ /$$$$$$  |/$$$$$$$/ $$ |  $$ |/$$$$$$  |$$ |$$$$$$/   $$ |  $$ |'
echo '$$$$$/ $$      \ $$    $$ |$$ |      $$ |  $$ |$$ |  $$/ $$ |  $$ | __ $$ |  $$ |'
echo '$$ |    $$$$$$  |$$$$$$$$/ $$ \_____ $$ \__$$ |$$ |      $$ |  $$ |/  |$$ \__$$ |'
...
echo '                                                                       $$$$$$/'
echo "v1.0"
echo "www.t2iservices.fr"
echo "FB.com/t2iservices"
}
...
echo -e "\n\n"
echo "[$] Legal Disclaimer: Usage of Fsecurity for attacking targets without prior mutual consent is illegal. It is the end user's responsibility to obey all applicable local, state and federal laws. Developers assume no liability and are not responsible for any misuse or damage caused by this program"
}
...
echo -n "[@] Would you like to download Burp Suite certificate? [y/n]. (Note: Burp Suite should be running in your machine): "; read -r burp_cert_answer
  ...
  if [[ ( $burp_cert_answer == 'y' ) || ( $burp_cert_answer == 'yes' ) ]];then
    ...
    if [ -s "$scriptpath/cacert.der" ];then
      ...
      echo "[!]Error: Fsecurity was not able to download Burp Suite certificate, you need to do this task manually."
    fi
  fi
...
# Ghostery
wget "https://addons.mozilla.org/firefox/downloads/latest/ghostery/addon-9609-latest.xpi" -o /dev/null -O "$scriptpath/ghostery.xpi"
...
# Serverspy2
wget "https://addons.mozilla.org/firefox/downloads/latest/server-spy2/addon-738237-latest.xpi?src=search" -o /dev/null -O "$scriptpath/serverspy2.xpi"
...
echo -e "[**] Fsecurity installation is finished\n"
echo -e "Have a nice day! - t2iservices"
